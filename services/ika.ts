 ...
 * Ika dWallet Service
 *
 * Wraps the Ika gRPC network and the linkora-custody on-chain program.
...
export const LINKORA_CUSTODY_PROGRAM_ID = new PublicKey(
  process.env.LINKORA_CUSTODY_PROGRAM_ID ?? '11111111111111111111111111111111',
);
