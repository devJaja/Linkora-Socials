      ...
      <View className="flex-row items-start justify-between">
        ...
        {isOwnProfile ? (
          ...
          <View className="flex-row gap-2">
            ...
            >
              <Icon as={isFollowing ? UserMinus : UserPlus} size={18} className={isFollowing ? "text-foreground" : "text-primary-foreground"} />
              <Text className={`font-semibold ${isFollowing ? 'text-foreground' : 'text-primary-foreground'}`}>
