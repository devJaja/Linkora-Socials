...
const liveApps = [
  {
    id: 'swap',
    name: 'Token Swap',
    description: 'Swap XLM for tokens instantly',
    icon: Coins,
    color: 'bg-blue-500',
  ...
  },
  {
    id: 'food',
    name: 'Food Delivery',
    description: 'Order food and pay with XLM',
  ...
  },
  {
    id: 'airdrop',
    name: 'Daily Airdrop',
    description: 'Claim your daily XLM rewards',
    icon: Gift,
    color: 'bg-purple-500',
...
const upcomingApps = [
  ...
  },
  {
    ...
    description: 'Predict XLM price and win',
    icon: TrendingUp,
    color: 'bg-red-500',
  },
];
