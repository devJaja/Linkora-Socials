...
### Monorepo (linkora-socials-app)
```
linkora-socials-app/                # Backend & Landing monorepo
├── .git/                   # Git repository
├── apps/
...
```
linkora-socials-app/                    # Mobile app (separate repo)
...
### Backend & Landing (linkora-socials-app)
...
### Backend
- Hosted on Render
- Deploy from `linkora-socials-app` repository
...
- Default: `https://api.linkora.social` (production)

## Shared Resources

### Types & Interfaces
- Backend types: `linkora-socials-app/apps/backend/src/types/`
- Mobile types: `linkora-socials-app/types/`
- Consider creating a shared types package in the future

### Documentation
- Backend API docs: `linkora-socials-app/apps/backend/README.md`
- Mobile setup: `linkora-socials-app/README.md`
- Landing page: `linkora-socials-app/apps/landing/README.md`
