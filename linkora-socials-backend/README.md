# Linkora Socials - Social Media on Stellar
...
A decentralized social media platform built on the Stellar blockchain with a React Native mobile app and NestJS backend.

## 🏗️ Repository Structure

Linkora is organized into two separate repositories:
...
### Mobile App (linkora-socials-app)
- **Tech Stack**: React Native, Expo, TypeScript
- **Features**: Social feed, wallet, mini apps, messaging
- **Repository**: [linkora-socials-app](../linkora-socials-app)
- **Deployment**: EAS (iOS App Store, Google Play)

### Backend API (linkora-socials-app/apps/backend)
- **Tech Stack**: NestJS, MongoDB, @stellar/stellar-sdk (Horizon)
- **Features**: User management, posts, wallet, mini apps
- **Deployment**: Render
- **API Docs**: See `apps/backend/README.md`

### Landing Page (linkora-socials-app/apps/landing)
- **Tech Stack**: Next.js 14, TypeScript, Tailwind CSS
- **Features**: Product showcase, waitlist signup
- **Deployment**: Vercel
- **URL**: https://linkora.social
...
- MongoDB
- Stellar Horizon (testnet for development)
...
See the [linkora-socials-app](../linkora-socials-app) repository for mobile app setup and development.

## 🎮 Features

- **Social Feed**: Create posts, like, comment, and share
- **Wallet**: Manage XLM and tokens
- **Mini Apps**: 
  - Token Swap
  - Food Delivery
  - Dice Game
...
- **Blockchain**: Stellar (@stellar/stellar-sdk), Horizon, DexScreener
...
This software is proprietary and source-available under the Linkora Proprietary License. 
...
For commercial licensing inquiries, please contact: team@linkora.social
...
- **Mobile**: See [linkora-socials-app](../linkora-socials-app) repository
