...
const NEW_KEYS: Record<string, Record<string, string>> = {
  ...
  'feed.pricePerToken': {
    en: 'Price per Token (XLM)',
    es: 'Precio por token (XLM)',
    fr: 'Prix par jeton (XLM)',
    de: 'Preis pro Token (XLM)',
    zh: '每个代币价格 (XLM)',
    ja: 'トークンあたりの価格 (XLM)',
    ko: '토큰당 가격 (XLM)',
    ar: 'السعر لكل رمز (XLM)',
    pt: 'Preço por token (XLM)',
    ru: 'Цена за токен (XLM)',
    hi: 'प्रति टोकन मूल्य (XLM)',
    it: 'Prezzo per token (XLM)',
  },
  'feed.tokenTip': {
  ...
  'feed.receivedTips': {
    en: 'Received {{amount}} XLM in tips',
    es: 'Recibió {{amount}} XLM en propinas',
    fr: 'A reçu {{amount}} XLM en pourboires',
    de: '{{amount}} XLM an Trinkgeldern erhalten',
    zh: '收到 {{amount}} XLM 小费',
    ja: 'チップで {{amount}} XLM を受け取りました',
    ko: '팁으로 {{amount}} XLM 받음',
    ar: 'تلقى {{amount}} XLM في الإكراميات',
    pt: 'Recebeu {{amount}} XLM em gorjetas',
    ru: 'Получено {{amount}} XLM чаевых',
    hi: 'टिप्स में {{amount}} XLM प्राप्त हुआ',
    it: 'Ricevuto {{amount}} XLM in mance',
  },
  // Common messages
  'feed.addressCopied': {
    en: 'Address copied!',
