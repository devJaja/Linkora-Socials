...
echo "3. Create an unsigned upload preset named 'linkora_uploads'"
echo "4. Update linkora-socials-backend/.env with:"
echo "   CLOUDINARY_CLOUD_NAME=your_cloud_name"
echo "   CLOUDINARY_UPLOAD_PRESET=linkora_uploads"
